...
var TreeNode = createReactClass({
	...
	getDefaultProps: function() {
		return {
			...
			checkboxFactory: function(className, isChecked) {
				return <input className={className} type="checkbox" checked={isChecked} onChange={function() {}} />
			},
		}
	},
	...
	_getCollapseNode: function() {
		...
		if (props.collapsible) {
			...
			collapseNode = <span onClick={collapseToggleHandler} className={collapseClassName} />
		}
		return collapseNode
	},
	...
	_getChildrenNode: function() {
		...
		return <div className={this._getRootCssClass() + '-children'}>{children}</div>
	},
